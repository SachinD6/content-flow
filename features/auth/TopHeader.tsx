      ...
      <div className="flex items-center gap-3 sm:gap-4 md:gap-6">
        <div className="relative hidden sm:flex items-center">
          ...
          <input
            type="text"
            placeholder="Search..."
            className="h-9 w-40 md:w-64 rounded-md border border-white/5 bg-[#121319] pl-9 pr-4 text-[13px] text-zinc-200 placeholder:text-zinc-500 focus:outline-none focus:ring-1 focus:ring-[#6154f0]/50"
          />
        </div>

        <div className="flex items-center gap-2 sm:gap-4 border-l border-white/5 pl-3 sm:pl-6">
          <button className="text-zinc-400 hover:text-white transition-colors relative cursor-pointer p-1">
            <Bell className="h-5 w-5" strokeWidth={2} />
            <span className="absolute top-0 right-0 h-1.5 w-1.5 rounded-full bg-[#6154f0]" />
          </button>
          
          <button className="hidden sm:block text-zinc-400 hover:text-white transition-colors cursor-pointer p-1">
