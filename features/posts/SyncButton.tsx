...
export function SyncButton() {
  ...
  return (
    <button
      onClick={handleSync}
      className="flex items-center gap-2 px-4 py-2 border border-white/5 bg-[#121319] hover:bg-white/5 rounded-[8px] text-[12px] font-bold text-zinc-300 transition-all shadow-md cursor-pointer"
    >
